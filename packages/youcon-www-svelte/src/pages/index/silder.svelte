...
class Sketch {
    constructor(opts) {
      ...
      this.leftClicker = document.getElementById("left");
      this.rightClicker = document.getElementById("right");
    ...
    clickEvent(){
      ...
      this.rightClicker.addEventListener('click',()=>{
        this.next();
      })
      this.leftClicker.addEventListener('click',()=>{
        this.next();
      })
    }
    settings() {
    ...
    addObjects() {
      ...
      this.material = new THREE.ShaderMaterial({
        ...
        uniforms: {
          ...
          displacement: { type: "f", value: new THREE.TextureLoader().load('img/img21.jpg') },
...
<div class="experts monitor">
    <div id="content" class="content">
		<div id="slider" data-images='["/img/img20.png","/img/img23.jpg","/img/img31.jpg"]'>
		</div>
	</div>
    <div class="tit">专家团队</div>
    <div class="desc">
        拥有一支具备物联网思维的在水处理工艺、水务管理运维、自动化 <br>
        控制、软件工程方面有着深厚技术积累及专业素养的专家团队
    </div>
    <div class="slider">
